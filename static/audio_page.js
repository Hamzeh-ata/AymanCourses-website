...
function ap_mute() {
    if (!ap_audio.muted) {
        ap_audio.muted = 1;
        o('.ap_sound').style.background  = 'url(./imgs/audio_muteicon.png)  no-repeat'
    } else {
        ap_audio.muted = 0;
        o('.ap_sound').style.background = 'url(./imgs/audio_unmuteicon.png)  no-repeat'
    }
}
...
function playsong() {
    ...
    track.play();
    Playing_song = true;
    play.style.background = 'url(./imgs/audio_pauseIcon.png)  no-repeat'
